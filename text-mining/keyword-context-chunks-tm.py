...
with open("india-pakistan.csv", "w", encoding = "utf-8", newline = '') as outfile: #open and write to csv file
...
outfile = "/Users/amcgrath1/college-news/india-pakistan-chunks/"
